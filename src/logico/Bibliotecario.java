...
public class Bibliotecario extends Persona{
    ...
    public Bibliotecario(String cedula, int tipo_usuario) {
    ...
    public Bibliotecario(int id_bib, int id_horario, String password, int id, String cedula, String primer_nombre, String segundo_nombre, String primer_apellido, String segundo_apellido, int  tipo_usuario, String email, String tipo_sangre, Date fecha_nac, String direccion, String genero, String telefono, boolean Estado) {

...
public class Ventana_Idiomas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comboEliminados = new javax.swing.JCheckBox();
        ...
        tablaIdiomas.setFocusable(false);
        ...
        comboEliminados.setText("FILTRAR ELIMINADOS");
        comboEliminados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                comboEliminadosMouseClicked(evt);
            }
        });
                ...
                .addGroup(backroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(backroundLayout.createSequentialGroup()
                        .addGroup(backroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(labelididioma, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(comboEliminados, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(19, 19, 19)
    ...
    private void txtcodigoidiomaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcodigoidiomaKeyTyped
        ...
        if (Character.isLetter(validar)) {
            ...
            if (txtcodigoidioma.getText().length() >= 10) {
                evt.consume();
            }
        }
    ...
    private void comboEliminadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_comboEliminadosMouseClicked
        if(comboEliminados.isSelected()){
            Modeloidioma.getTablaEliminados();
        }else {
            Modeloidioma.getTabla();
        }
    }//GEN-LAST:event_comboEliminadosMouseClicked
    ...
    private javax.swing.JCheckBox comboEliminados;

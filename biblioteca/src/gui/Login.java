        ...
        if(txtuser.getText().length()>0) {
            if(passworduser.getPassword().length>0) {
                for (int i = 0; i < ControladorUsuario.listausuarios.size(); i++) {
                    if (txtuser.getText().equals(ControladorUsuario.listausuarios.get(i).getCedula()) && passworduser.getText().equals(ControladorUsuario.listausuarios.get(i).getPassword())) {
                        String rol = ControladorUsuario.listausuarios.get(i).getTipo_usuario();
                        String nombre = ControladorUsuario.listausuarios.get(i).getNombre().toUpperCase();
                        String apellido = ControladorUsuario.listausuarios.get(i).getApellido().toUpperCase();
